public class Wizard extends Character{
    ...
    public void spitfire(Character enemyCharacter, Character name){
        int damagePoints = 40;
        int manadecrease = 30;
        System.out.println(super.characterName + " attacks " + enemyCharacter.characterName + " with Spitfire (Damage - 40)");
        damageTarget(enemyCharacter,damagePoints,manadecrease,name);
    }
}